...
public class SQLConstant {
	public final static String VALIDATE_USER = "select exists(select * from user where username = '%s' AND password = '%s' AND roleID = '%d')";
	...
	public final static String GET_PROFESSOR_FOR_COURSE = "SELECT EXISTS(SELECT * FROM course WHERE courseID = %d AND professorID = %d)";
	public final static String CHECK_FOR_COURSE = "SELECT EXISTS(SELECT * FROM registration WHERE courseID = %d)";
	...
	public final static String CHECK_IF_COURSE_EXIST = "select exists(select * from course where courseID = %d)";
}